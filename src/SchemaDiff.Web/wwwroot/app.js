...
const I18N = {
  en: {
    ...
    opt_ignoreExtendedProperties: 'Ignore extended properties', optn_ignoreExtendedProperties: 'Descriptions like MS_Description are not compared. Default: ignored (turn off to compare them, as SSDT does).',
  ...
  tr: {
    ...
    opt_ignoreExtendedProperties: 'Extended property\'leri yok say', optn_ignoreExtendedProperties: 'MS_Description gibi açıklamalar karşılaştırılmaz. Varsayılan: yok sayılır (karşılaştırmak için kapat — SSDT karşılaştırır).',
